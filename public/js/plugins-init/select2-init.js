...
(function($) {
  ...
  $("#js-programmatic-toggle").on("click", function () {
      // Sprawdzenie, czy pole jest wyłączone
      var isDisabled = $(".js-example-disabled-multi").prop("disabled");

      // Przełączanie stanu disabled dla obu pól
      $(".js-example-disabled-multi").prop("disabled", !isDisabled);
  });
  ...
  // $(".multi-select-placeholder-courses").select2({
  ...
  $(".multi-select-placeholder-sets").select2({
      placeholder: "Wybierz sety pytań",
  });

    $(".multi-select-placeholder-answers").select2({
    });
  ...
  $("#questionCorrectMultiAnswer").select2({
