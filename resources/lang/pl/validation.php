...
return [
    ...
    'url'                  => 'Format adresu url jest nieprawidłowy. Sprawdź, czy adres posiada prawidłowy przedrostek https://',
    'uuid'                 => 'Pole :attribute musi być poprawnym identyfikatorem UUID.',

    //Nazwy inputów:
    'attributes' => [
        'password' => "Hasło",
        'regulation' => "'Akceptuję regulamin'",
        'name' => "Imię/Nazwisko",
        'email' => "Adres email",
        'courseName' =>"Nazwa kursu",
        'courseDescription' =>"Opis kursu",
        'setName' =>"Nazwa zestawu",
        'setDescription' =>"Opis zestawu",
        'courseSetName' =>"Nazwa pierwszego zestawu",
        'courseSetDescription' =>"Opis pierwszego zestawu",
        'setNameEdit'=>'Nazwa zestawu',
        'setDescriptionEdit'=>'Opis zestawu',
        'courseNameEdit'=>'Nazwa kursu',
        'courseDescriptionEdit'=>'Opis kursu',
        'reportDescription' => 'Opis błędu',
        'forgotEmail' => "Email"
    ]
